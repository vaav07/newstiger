...
export class News extends Component {
  ...
  async updateNews() {
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=03362fbea67141c385ff6546c0193e75&page=${this.props.page}&pageSize=${this.props.pageSize}`;
  ...
  render() {
    return (
      <div className="container my-3">
        <h1 className="text-center">NewsTiger - Top {this.capitalizefirstLetter(this.props.category)} Headlines</h1>
